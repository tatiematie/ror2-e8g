...
<div class="heading">
	<div class="corners">
		<img src="{base}/images/items/tri-tip-dagger.png" alt="Tri-Tip Dagger" />
	</div>
	<div class="title">
	...
	<div class="section">
		...
		<p>
			...
			chance to <span class="yellow text">bleed</span><span class="inline img"
				>&nbsp;<img src="{base}/images/effects/bleed.png" alt="Bleed" /></span
			>
			...
			<span class="pink text">Corrupted by Needletick</span><span class="inline img"
				>&nbsp;<img src="{base}/images/items/needletick.png" alt="Needletick" /></span
			>.
		</p>
	</div>
	<div class="section">
		...
		<p class="light-gray text">
			...
			Tri-Tip Daggers<span class="inline img"
				>&nbsp;<img src="{base}/images/items/tri-tip-dagger.png" alt="Tri-Tip Dagger" /></span
			>. The best examples of this are Commando<span class="inline img"
				>&nbsp;<img src="{base}/images/survivors/commando.png" alt="Commando" /></span
			>
			and MUL-T<span class="inline img"
				>&nbsp;<img src="{base}/images/survivors/mul-t.png" alt="MUL-T" /></span
			>.
		</p>
		<p class="light-gray text">
			...
			stacking comes from survivors with multi-hit attacks like Captain's<span class="inline img"
				>&nbsp;<img src="{base}/images/survivors/captain.png" alt="Captain" /></span
			>
			Vulcan Shotgun<span class="inline img"
				>&nbsp;<img
					src="{base}/images/survivors/skills/vulcan-shotgun.png"
					alt="Vulcan Shotgun"
				/></span
			>
			or either of Engineer's<span class="inline img"
				>&nbsp;<img src="{base}/images/survivors/engineer.png" alt="Engineer" /></span
			>
			Turret<span class="inline img"
				>&nbsp;<img
					src="{base}/images/survivors/skills/tr12-gauss-auto-turret.png"
					alt="TR12 Gauss Auto-Turret"
				/></span
			>/<span class="inline img"
				>&nbsp;<img
					src="{base}/images/survivors/skills/tr58-carbonizer-turret.png"
		...
		<p class="light-gray text">
			Survivors without high fire rate can use The Crowdfunder<span class="inline img"
				>&nbsp;<img src="{base}/images/items/the-crowdfunder.png" alt="The Crowdfunder" /></span
			>
		...
		<ul class="content synergies">
			...
			<li class="common item or" title="Delicate Watch">
				<button type="button" on:click={() => updatePage('Delicate Watch')}>
					<img src="{base}/images/items/delicate-watch.png" alt="Delicate Watch" />
				</button>
			</li>
			<li class="common item" title="Armor Piercing Rounds">
				<button type="button" on:click={() => updatePage('Armor Piercing Rounds')}>
					<img src="{base}/images/items/armor-piercing-rounds.png" alt="Armor Piercing Rounds" />
				</button>
			</li>
		</ul>
		<p class="light-gray text">
			...
			damage is dependent on the survivor's base damage, Delicate Watch<span class="inline img"
				>&nbsp;<img src="{base}/images/items/delicate-watch.png" alt="Delicate Watch" /></span
			>
			increases your base damage and, by extension, your <span class="yellow text">bleed</span><span
				class="inline img">&nbsp;<img src="{base}/images/effects/bleed.png" alt="Bleed" /></span
			> damage.
		</p>
		<p class="light-gray text">
			Armor Piercing Rounds<span class="inline img"
				>&nbsp;<img
					src="{base}/images/items/armor-piercing-rounds.png"
	...
	<div class="section">
		...
		<p class="light-gray text">
			...
			case, Double Tap<span class="inline img"
				>&nbsp;<img src="{base}/images/survivors/skills/double-tap.png" alt="Double Tap" /></span
			>
		...
		<div id="calc" class="linear">
			...
			<div id="modifier" title="# of 57 Leaf Clovers">
				<img src="{base}/images/items/57-leaf-clover.png" alt="57 Leaf Clover" />
				<span class="gray text">x</span>
				<input
					type="text"
					name="57-leaf-clover"
